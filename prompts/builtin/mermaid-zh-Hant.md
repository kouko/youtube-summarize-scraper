...
- 用箭頭標籤說明節點之間「為什麼」或「如何」連接：A -->|導致| B。例如：因果（導致、造成）、條件（若成功、若失敗）、方式（透過 API）、反饋（修正）。標籤控制在 2-6 字
- 每個圖表 5-12 個節點
...
- 每個節點的標題控制在 20 字以內，細節控制在 30 字以內
...
B --> D["因素二<br/>━━━━━━<br/>成本上升"]
B --> E["因素三<br/>━━━━━━<br/>需求萎縮"]
C --> F["影響評估<br/>━━━━━━<br/>對市場的衝擊"]
D --> F
E --> F
F ==> G["結論<br/>━━━━━━<br/>投資建議與展望"]
...
```mermaid
graph LR
H["現況問題<br/>━━━━━━<br/>效率低落"] --> I["方案A<br/>━━━━━━<br/>自動化流程"]
H --> J["方案B<br/>━━━━━━<br/>外包處理"]
I --> K["評估結果<br/>━━━━━━<br/>成本與效益比較"]
J --> K
K ==> L["最終決策<br/>━━━━━━<br/>採用方案A"]
