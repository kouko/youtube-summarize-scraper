...
- 矢印ラベルでノード間の「なぜ」「どのように」を説明する：A -->|原因| B。例：因果（導く、引き起こす）、条件（成功時、失敗時）、手段（API経由）、フィードバック（修正）。ラベルは2-6文字に収める
- 各図表 5-12 個のノード
...
- 各ノードのタイトルは20文字以内、詳細は30文字以内に収める
...
B --> C["要因1<br/>━━━━━━<br/>サプライチェーン中断"]
B --> D["要因2<br/>━━━━━━<br/>コスト上昇"]
B --> E["要因3<br/>━━━━━━<br/>需要縮小"]
C --> F["影響評価<br/>━━━━━━<br/>市場への影響"]
D --> F
E --> F
F ==> G["結論<br/>━━━━━━<br/>今後の展望"]
...
```mermaid
graph LR
H["現状の問題<br/>━━━━━━<br/>効率の低下"] --> I["方案A<br/>━━━━━━<br/>自動化導入"]
H --> J["方案B<br/>━━━━━━<br/>外部委託"]
I --> K["評価結果<br/>━━━━━━<br/>コスト効果の比較"]
J --> K
K ==> L["最終決定<br/>━━━━━━<br/>方案Aを採用"]
