...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&llmOverride, "llm", "", "override LLM backend (ollama/llamacpp/claude-api/claude-code/gemini-cli/antigravity-cli/qwen-code/openai-compat); use openai-compat:<name> to target a named instance, bare openai-compat = the default instance")
